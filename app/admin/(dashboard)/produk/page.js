    ...
    <div>
      ...
      <form method="get" className="flex flex-wrap items-center gap-2.5 mb-5">
        <input
          ...
          className="border border-[var(--line)] rounded-sm px-3 py-2 text-sm w-52"
        />
        <select name="kategori" defaultValue={searchParams.kategori || ""} className="border border-[var(--line)] rounded-sm px-3 py-2 text-sm bg-white">
